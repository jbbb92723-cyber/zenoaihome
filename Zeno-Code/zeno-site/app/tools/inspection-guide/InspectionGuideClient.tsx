...
import { BridgePanel, ResultPanel, ToolPageShell } from '@/components/features/tools/ToolPageShell'
    ...
    <ToolPageShell label="装修验收向导" title="验收不是挑刺，是把问题留在付款之前。" subtitle="选择当前施工节点，得到一份业主能看懂、能拍照、能沟通的验收清单。它不替代第三方监理，但能先把明显风险拦住。" bestFor="正在施工或准备阶段验收的人" time="5-10 分钟" prepare={["当前施工节点", "现场照片", "报价/合同"]}>
      ...
      <section className="mx-auto max-w-6xl px-5 pb-12 sm:px-8">
        <BridgePanel items={[
          ...
          { label: '找 Zeno 判断现场问题', href: '/services/node-advisor', desc: '清单看完仍不确定，可以查看装修专项判断的施工节点场景。' },
