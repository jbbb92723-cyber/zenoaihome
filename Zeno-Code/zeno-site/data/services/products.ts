...
export const PRODUCTS: Product[] = [
  {
    ...
    name:         '星火者 · 90 天实践共同体验证席',
    tagline:      '8-10 人，用 90 天验证一次真实行动、连接或复盘',
    type:         'membership',
    value:        `${SPARK_COMMUNITY_PLAN}:${SPARK_COMMUNITY_DURATION_DAYS}`,
    price:        SPARK_COMMUNITY_PRICE,
    category:     '星火者',
    bestFor:      '正在推进一件具体事情，愿意带着目标、能力和边界参与的小规模实践者。',
    deliverable:  '90 天成员资格、每月两次固定活动、实践档案、一次连接尝试与结营复盘。',
    description:  [
      '申请与 15 分钟面聊，先确认目标、投入和边界',
      '每月一次真实问题工作会与一次案例共读复盘',
      '90 天内可提出一次有上下文的成员连接请求',
      '72 小时无条件退款',
    ],
    badge:        '首期 8-10 人',
    isActive:     true,
