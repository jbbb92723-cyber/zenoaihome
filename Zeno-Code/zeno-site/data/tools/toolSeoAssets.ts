...
export const toolSeoAssets = {
  quoteCheck: {
    ...
    links: [
      ...
      { label: '报价 / 合同人工审查', href: '/services/quote-review', desc: '已有完整报价、合同草稿或付款节点时，再进入人工审查。' },
  ...
  budgetStructure: {
    ...
    links: [
      ...
      { label: '报价 / 合同人工审查', href: '/services/quote-review', desc: '预算越算越乱时，先回到完整报价和合同边界，看漏项和增项口子有没有写清。' },
