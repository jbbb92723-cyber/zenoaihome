...
export const toolSeoAssets = {
  quoteCheck: {
    ...
    searchIntent: '适合搜索“装修报价单怎么看”“装修报价漏项怎么查”“报价边界怎么判断”的用户。',
    ...
    faqs: [
      { question: '装修报价初筛能替代人工快审吗？', answer: '不能。初筛工具适合先把明显风险找出来，人工快审适合在你已经准备签约、报价单较复杂或金额较高时进一步判断。' },
    ...
    links: [
      ...
      { label: '装修专项判断', href: '/services/quote-review', desc: '已有完整报价、合同草稿或付款节点时，再进入 ¥2,500 专项判断。' },
  ...
  budgetStructure: {
    ...
    links: [
      ...
      { label: '装修专项判断', href: '/services/quote-review', desc: '预算越算越乱时，先回到完整报价和合同边界，看漏项和增项口子有没有写清。' },
  ...
  paintCalculator: {
    ...
    links: [
      ...
      { label: '联系赞诺说明情况', href: '/contact', desc: '方案、预算、报价、合同和付款节点都已经有，且临近签约时再沟通是否需要人工判断。' },
    ],
  },
  inspectionGuide: {
    ...
    links: [
      ...
      { label: '找 Zeno 做装修专项判断', href: '/services/quote-review', desc: '报价、合同和付款节点仍不确定，可以查看 ¥2,500 专项判断的交付与边界。' },
