...
export const checklistTemplates: ChecklistTemplate[] = [
  ...
  {
    id: 'ct-project-record-keeping',
    slug: 'project-record-keeping',
    title: '装修工程签约与留痕清单',
    subtitle: '从合同附件、工程变更到材料代购与节点付款，把双方需要确认的事项留完整。',
    suitableFor: [
      '正在签合同或准备进场的消费者',
      '需要规范项目记录的装修从业者',
      '施工中频繁发生变更、增项或代购的项目',
    ...
    beforeYouStart: [
      '准备合同正文、报价单、补充协议和现有沟通记录，不要只看其中一份材料。',
      '确认甲乙双方、项目名称、合同编号和有权确认变更的人员。',
      '以下模板只提供项目管理参考，重要合同和争议事项仍需结合项目所在地规则请专业人士复核。',
    ],
    sections: [
      {
        title: '签约时把结算依据固定下来',
        items: [
          {
            check: '明确采用单价包干还是总价包干，并把预算单价表逐项核对、签字或盖章后作为合同附件保存。',
            why: '合同只写结算方式、没有对应单价和附件，后续很难核对工程量与结算金额。',
            relatedRiskIds: ['qr-01', 'qr-04', 'qr-05'],
          },
          {
            check: '写清材料品牌、型号、规格、数量、价格，以及由谁指定、由谁确认和缺货时如何替换。',
            why: '材料名称过于笼统，代购、替换和结算就会留下不同解释。',
            relatedRiskIds: ['qr-02', 'qr-08', 'qr-16'],
          },
          {
            check: '把付款节点对应到验收动作，并约定变更程序、工期顺延条件和投入使用后的验收处理方式。',
            why: '付款、验收、变更和工期彼此脱节，出现分歧时很难判断下一步由谁负责。',
            relatedRiskIds: ['qr-13', 'qr-14', 'qr-17', 'qr-18'],
          },
        ],
      },
      {
        ...
        items: [
          {
            check: '签证单同时填写变更原因、具体内容、工程量、单价、金额、工期影响和双方确认。',
            why: '只确认“做什么”、不确认数量和价格，仍然无法形成完整结算依据。',
            relatedRiskIds: ['qr-05', 'qr-14', 'qr-15'],
          },
          {
            check: '原则上先确认费用和工期影响再施工；现场先口头沟通的，尽快把结论发成文字并补齐签证。',
            why: '变更已经完成后再谈价格，双方都容易用自己的理解还原当时约定。',
            relatedRiskIds: ['qr-14', 'qr-15'],
          },
          {
            check: '返工、窝工、停工等待或赶工时，记录原因、涉及人员、持续时间、费用和工期影响。',
            why: '只记录结果、不记录原因与影响，后续很难区分原合同工作和新增责任。',
            relatedRiskIds: ['qr-14', 'qr-18'],
          },
        ],
      },
      {
        ...
        items: [
          {
            check: '下单前确认品牌、型号、规格、数量、单价、预计总价，以及款式由谁指定。',
            why: '先付款后确认，容易同时出现选型、价格和数量三类争议。',
            relatedRiskIds: ['qr-02', 'qr-08', 'qr-16'],
          },
          {
            check: '下单后保留付款凭证、订单、物流信息和到货验收记录，并让双方能对应到具体项目。',
            why: '只有转账记录，不能完整说明买了什么、为哪个项目购买、是否已经交付。',
            relatedRiskIds: ['qr-05', 'qr-13'],
          },
          {
            check: '提前写清垫付款如何结算、发票或收据归谁、退换货费用和材料剩余如何处理。',
            why: '代购结束后的票据、退款和剩余材料，也可能影响最终结算。',
            relatedRiskIds: ['qr-13', 'qr-16', 'qr-19'],
          },
        ],
      },
      {
        ...
        items: [
          {
            check: '电话或现场沟通后，用文字汇总事项、金额、工期和待确认内容；每周整理一次进度、下周计划和待确认项。',
            why: '文字汇总能帮助双方及时纠正理解偏差，也便于之后按时间还原项目过程。',
            relatedRiskIds: ['qr-14', 'qr-15', 'qr-18'],
          },
          {
            check: '在进场、隐蔽工程、材料到场和每个验收节点拍照或录像，并标注时间、位置和对应事项。',
            why: '关键节点被覆盖后很难重新检查，原始影像可以保留当时状态。',
            relatedRiskIds: ['qr-11', 'qr-17'],
          },
          {
            check: '付款、收款和代购使用可追溯方式并备注用途；合同、单据、聊天和影像至少保留一份独立备份。',
            why: '项目记录只存在一台设备或没有用途备注，遗失后难以重新对应。',
            relatedRiskIds: ['qr-13', 'qr-19'],
          },
        ],
      },
      {
        ...
        items: [
          {
            check: '书面列明已完成事项、合同依据、待付款项或待整改事项，并给出明确、合理的回复期限。',
            why: '先把双方当前分歧写清，后续协商和专业判断才有共同起点。',
            relatedRiskIds: ['qr-13', 'qr-17', 'qr-18'],
          },
          {
            check: '保留现场原状、原始文件和每次协商结论；涉及人身、财产安全或涉嫌违法时，联系有关部门处理。',
            why: '现场被覆盖、资料被修改或原文件遗失后，事实核对成本会明显增加。',
            relatedRiskIds: ['qr-17', 'qr-20'],
          },
          {
            check: '涉及较大金额、停工、解除合同、造价争议或诉讼时，尽早请律师、造价或工程专业人员结合完整材料判断。',
            why: '通用清单不能替代对具体合同、证据和当地规则的专业审查。',
            relatedRiskIds: [],
          },
        ],
      },
    ...
    formTemplates: [
      {
        title: '工程变更签证单',
        fields: ['工程名称与合同编号', '变更日期与签证单编号', '变更原因与具体内容', '工程量、单价与金额', '工期影响', '甲乙双方确认'],
      },
      {
        title: '增项确认单',
        fields: ['增项项目', '规格与数量', '单价与小计', '工期影响', '双方确认与日期'],
      },
      {
        title: '返工/窝工确认单',
        fields: ['事项类型', '发生原因', '涉及人员与持续时间', '费用与工期影响', '双方确认与日期'],
      },
    ],
    communicationScripts: [
      {
        title: '代购前确认',
        body: '您好，材料拟选用 XX 品牌 XX 型号，规格 XX，单价 XX 元，预计需要 XX，合计约 XX 元。请确认品牌、型号、数量和价格；收到您的明确回复后，我再安排下单。',
      },
      {
        title: '代购后留档',
        body: '您好，已按此前确认的内容购买 XX 材料，本次付款 XX 元，付款凭证和订单信息附后，物流单号为 XX。到货后请共同核对数量、型号和外观。',
      },
      {
        title: '变更确认',
        body: '您好，今天沟通的变更为：将 XX 位置由 XX 调整为 XX。预计增加费用 XX 元，工期调整约 X 天。我会把具体内容写入签证单，请确认后再安排施工。',
      },
      {
        title: '节点付款提醒',
        body: '您好，XX 工程已于 X 月 X 日完成验收。按合同约定，本节点应付 XX 元，请于 X 月 X 日前安排。款项到账后，我们按计划继续下一阶段施工。',
      },
    ],
    sourceNote: '这份清单根据本人真实项目经验整理，公开版本已经移除项目名称、具体金额、当事人称呼和可重识别的纠纷细节。',
    printableHref: '/renovation-project-record-checklist.html',
    usageBoundary: '本清单用于一般性的经验分享和项目管理参考，不针对任何具体个人或企业，也不能替代合同审查、工程造价鉴定或法律意见。不同地区、项目类型和合同文本可能适用不同规则，重要事项请结合实际情况请专业人士复核。',
    nextStep: '先从当前阶段最容易失去记录的一件事开始补：尚未签约就补齐附件，正在变更就补签证，已经代购就把订单、付款和验收记录对应起来。',
  },
]
