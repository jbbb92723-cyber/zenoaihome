...
const REPLACEMENTS = {
  'baojia-dan-zhenzheng-zenme-kan': {
    ...
    母文Path: resolve(ROOT, '../Zeno-Content/赞诺内容资产库/06_内容资产单元/2026-报价单真正该怎么看/03_重构母文.md'),
  },
  'zhuangxiu-yusuan-weishenme-zongchao': {
    slug: 'zhuangxiu-yusuan-weishenme-zongchao',
    母文Path: resolve(ROOT, '../Zeno-Content/赞诺内容资产库/06_内容资产单元/2026-装修预算为什么总超/03_重构母文.md'),
  },
  'article-01-03': {
    slug: 'article-01-03',
    母文Path: resolve(ROOT, '../Zeno-Content/赞诺内容资产库/06_内容资产单元/2026-实住派装修究竟反对什么/03_重构母文.md'),
  },
}
