...
```bash
python "G:/Zenoaihome.com/赞诺内容资产库/08_内容发布/00_Zeno发布中台/_scripts/zeno_publish_sync.py" --dry-run
```

真正复制输出：

```bash
python "G:/Zenoaihome.com/赞诺内容资产库/08_内容发布/00_Zeno发布中台/_scripts/zeno_publish_sync.py" --apply
```
