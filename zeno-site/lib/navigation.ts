...
export const primaryNav: PrimaryNavItem[] = [
  ...
  },
  {
    ...
    groups: [
      {
        key: 'paths',
        zh: { label: '按问题进', desc: '哪个最急，从哪个开始' },
        en: { label: 'By Problem', desc: 'Start with your most urgent issue' },
        items: [
          { key: 'path-quote', zh: { label: '报价看不清', href: '/start#quote', desc: '先做风险初筛' }, en: { label: 'Quote Risks', href: '/en', desc: 'Screen first' } },
          { key: 'path-budget', zh: { label: '预算分不清', href: '/start#budget', desc: '先拆钱再查超支原因' }, en: { label: 'Budget Split', href: '/en', desc: 'Split then check' } },
          { key: 'path-construction', zh: { label: '开工不知盯什么', href: '/start#construction', desc: '按节点做确认和留痕' }, en: { label: 'Build Checkpoints', href: '/en', desc: 'Inspect by stage' } },
          { key: 'path-living', zh: { label: '怕住进去不顺手', href: '/start#living', desc: '先写清真实需求' }, en: { label: 'Real Living', href: '/en', desc: 'Needs before style' } },
          { key: 'path-ai', zh: { label: 'AI 接进业务', href: '/start#ai', desc: '拿真实任务先跑一轮' }, en: { label: 'AI In Work', href: '/en', desc: 'Run a real task first' } },
        ],
      },
    ],
  },
