...
export interface QuoteRiskRule {
  id: string
  title: string
  trigger: string
  why: string
...
export const quoteRiskDictionary: QuoteRiskDictionaryItem[] = [
  {
    id: 'missing-items',
    term: '漏项',
    plain: '报价里本该出现却没出现的项目。',
    whatToLookFor: '垃圾外运、保护、收口、调试、辅材和现场杂费。',
  },
  {
    id: 'vague-items',
    term: '模糊项',
    plain: '描述太泛，后期容易被换掉或加价。',
    whatToLookFor: '品牌写得太笼统、工艺只写“按规范施工”。',
  },
  {
    id: 'change-order-door',
    term: '增项口子',
    plain: '先不写清，后面再补钱的入口。',
    whatToLookFor: '按实结算、暂定、现场另计、变更另算。',
  },
  {
    id: 'measurement-rule',
    term: '工程量',
    plain: '到底做多少。',
    whatToLookFor: '按面积、长度、点位还是实际发生量。',
  },
  {
    id: 'process-boundary',
    term: '工艺边界',
    plain: '怎么做、做到什么程度。',
    whatToLookFor: '基层处理、遍数、厚度、是否含找平和修补。',
  },
  {
    id: 'material-boundary',
    term: '材料边界',
    plain: '用什么材料、能不能替换。',
    whatToLookFor: '品牌、型号、规格、环保等级、替换规则。',
  },
  {
    id: 'acceptance-standard',
    term: '验收标准',
    plain: '做完后按什么算合格。',
    whatToLookFor: '节点验收、空鼓、平整度、闭水、色差、收口。',
  },
  {
    id: 'payment-milestone',
    term: '付款节点',
    plain: '钱什么时候付、付多少。',
    whatToLookFor: '是否和验收节点对应，尾款是否足够。',
  },
  {
    id: 'warranty-scope',
    term: '质保范围',
    plain: '后期哪些问题算谁的。',
    whatToLookFor: '保修多久、保什么、不保什么。',
  },
]

export const quoteRiskRules: QuoteRiskRule[] = [
  {
    id: 'low-price-does-not-mean-low-risk',
    title: '总价低，不代表风险低',
    trigger: '看到明显低价时',
  ...
  {
    id: 'verbal-promises-need-writing',
