...
export const toolSeoAssets = {
  ...
  budgetStructure: {
    ...
    description: '输入总预算和面积，把装修预算拆成硬装、主材、定制、设备、软装和缓冲金。',
    searchIntent: '适合搜索“装修预算怎么分配”“装修预算表”“装修预算比例”的用户。',
    scenarioTitle: '典型场景：你有总预算，但不知道钱该先放在哪里',
    scenario: [
      '很多预算失控，不是因为一开始没钱，而是钱的顺序错了。先被风格、主材、家电带着走，最后基础硬装、收纳和缓冲金反而被挤掉。',
      '预算结构工具先把总价拆成几个桶：基础硬装、主材、定制、设备、软装和缓冲。你会看到每一类大概能放多少钱，而不是只盯一个总数。',
      '这个结果不是最终报价，而是一张“取舍地图”。当某一项明显超出结构范围，你就知道要么提高总预算，要么从其他桶里主动取舍。',
    ],
    zenoNote: '预算的核心不是省钱，而是让钱先服务长期居住。真正该守住的是基础、收纳、动线和缓冲。',
    nationalNote: '不同城市的价格差异很大，但预算结构可以全国通用。你可以用本工具先看比例，再用本地报价修正金额。',
    faqs: [
      { question: '装修预算结构工具给出的比例是固定标准吗？', answer: '不是。它是一个普通家庭做初步判断的结构参考，具体比例要根据房屋状态、城市行情、家庭生活方式和装修目标调整。' },
      { question: '为什么一定要留缓冲金？', answer: '装修里几乎一定会遇到现场条件、临时调整或未写清费用。没有缓冲金，预算会被任何一个小变更打穿。' },
      { question: '预算结构和预算风险自测有什么区别？', answer: '预算结构工具解决“钱怎么分”，预算风险自测解决“你现在更像卡在哪一类风险”。一个偏规划，一个偏诊断。' },
    ],
    links: [
      { label: '预算风险自测', href: '/tools/budget-risk', desc: '结构看完后，继续判断风险来自报价、流程还是需求。' },
  ...
  tileCalculator: {
    ...
    links: [
      ...
      { label: '预算结构工具', href: '/tools/budget-structure', desc: '把瓷砖费用放回主材预算桶。' },
