...
export const toolSeoAssets = {
  quoteCheck: {
    ...
    links: [
      ...
      { label: '标准报价快审', href: '/services/renovation#quote-standard', desc: '已有完整报价、准备继续谈或签约时，再进入人工快审。' },
  ...
  budgetStructure: {
    ...
    links: [
      ...
      { label: '标准报价快审', href: '/services/renovation#quote-standard', desc: '预算越算越乱时，先回到完整报价，看漏项和增项口子有没有写清。' },
  ...
  paintCalculator: {
    ...
    links: [
      ...
      { label: '深度版签约前判断', href: '/services/renovation#quote-deep', desc: '报价、合同和付款节点都已经有，且临近签约时再进入服务。' },
    ],
  },
  inspectionGuide: {
