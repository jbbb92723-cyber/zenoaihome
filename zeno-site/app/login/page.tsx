...
function LoginForm() {
  ...
  const [error, setError]       = useState(errorParam ? '登录失败，请检查邮箱和密码。' : '')
    ...
    <Container size="content" className="py-section">
      <div className="max-w-sm mx-auto">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 text-sm font-medium text-ink border border-border px-4 py-2.5 hover:bg-surface-warm transition-colors"
        >
