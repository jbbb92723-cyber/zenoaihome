...
const suitableFor = [
  { title: '报价风险初筛',    desc: '已经拿到装修报价，但看不懂里面有没有坑。' },
  { title: '合同风险初筛',   desc: '准备签合同，但担心口头承诺和付款节点没有写清。' },
  { title: '报价对比判断',   desc: '手里有 2-3 家装修公司报价，不知道怎么选。' },
        ...
        <section className="mb-14">
          ...
          <div className="border border-border bg-surface p-6 space-y-4">
            {[
              ...
              '你希望我帮你做免费分流、报价风险初筛、合同风险初筛，还是报价对比判断',
            ].map((tip, i) => (
