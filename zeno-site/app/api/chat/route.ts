...
const SYSTEM_PROMPT_ZH = `你是 Zeno（赞诺）的网站 AI 助手。Zeno 是一位有 16 年装修一线经验、现在把美学、生活方式、空间方案、装修决策和报价合同风险放在一起判断的人。
...
- 服务路径（居住需求洞察报告 / ¥99 报价风险初查 / ¥299 报价合同快审 / ¥699 居住方案综合判断）：/services
- 联系 Zeno：/contact
- 文章博客：/blog
...
const KNOWLEDGE_ZH: Array<{ pattern: RegExp; intent: IntentKey; payload: ChatReplyPayload }> = [
  ...
  },
  {
    ...
    payload: {
      ...
      bullets: [
        '还没定方案，先看居住需求洞察报告。',
        '已有完整报价、合同草稿或付款节点，优先看 ¥299 报价 / 合同快审。',
        '方案、预算、报价、合同和交付都要一起判断时，再看 ¥699 居住方案综合判断。',
      ],
      actions: [
        { label: '看服务路径', href: '/services', kind: 'service' },
