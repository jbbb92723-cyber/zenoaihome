...
- 服务价格（¥99 / ¥299 / ¥699）：/services/renovation
- 联系 Zeno：/contact
- 文章博客：/blog
...
const ROUTE_LABELS: Record<'zh' | 'en', Record<string, string>> = {
  zh: {
    ...
    '/services/renovation#quote-entry': '了解 ¥99 体验版初查',
    '/services/renovation#quote-standard': '了解 ¥299 标准版快审',
    '/services/renovation#quote-deep': '了解 ¥699 深度版',
...
const FOLLOW_UPS_ZH: Record<IntentKey, string[]> = {
  ...
  quote: ['你先教我怎么看漏项', '这种按实际发生怎么算风险', '我该选 ¥299 还是 ¥699'],
  service: ['¥99 适合什么情况', '¥299 和 ¥699 区别是什么', '我先用工具还是先咨询'],
...
const KNOWLEDGE_ZH: Array<{ pattern: RegExp; intent: IntentKey; payload: ChatReplyPayload }> = [
  ...
  },
  {
    ...
    intent: 'service',
    payload: {
      reply: '现在主线只保留三档人工判断：¥99 体验版初查、¥299 标准版快审、¥699 深度版签约前判断。不是所有情况都需要直接买服务，能先用免费初筛和检查模板看清的，先看清再说。',
      bullets: [
        '只有几行重点报价，优先看 ¥99 体验版。',
        '有完整报价准备继续谈，优先看 ¥299 标准版。',
        '报价、合同和付款节点一起看不清，优先看 ¥699 深度版。',
      ],
      actions: [
