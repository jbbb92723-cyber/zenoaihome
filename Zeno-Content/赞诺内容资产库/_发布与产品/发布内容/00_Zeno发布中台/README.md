...
→ 05_published_已发布
→ 06_feedback_数据反馈
→ 回填 05_素材证据库 / 06_内容资产单元 / 14_方法论与可调用方法库
```
...
```bash
python "G:/Zenoaihome.com/Zeno-Content/赞诺内容资产库/08_内容发布/00_Zeno发布中台/_scripts/zeno_publish_sync.py" --dry-run
```

真正复制输出：

```bash
python "G:/Zenoaihome.com/Zeno-Content/赞诺内容资产库/08_内容发布/00_Zeno发布中台/_scripts/zeno_publish_sync.py" --apply
```
